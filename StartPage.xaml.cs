...
{
    public List<ContentPage> lehed = new List<ContentPage>() {new List_Page(), new EuroopaRiigid_Page() };
    public List<string> tekstid = new List<string> { "Tee lahti List_Page", "Tee Euroopa riigid" };
